...
data class ProfileUpdateRequest(
    val gender: com.example.anbdapi.domain.auth.entity.Gender,          // 예: MALE, FEMALE, OTHER 등 (enum으로 정의되어 있다고 가정)
    ...
    val shareCategory: com.example.anbdapi.domain.auth.entity.ShareCategory? = null
)